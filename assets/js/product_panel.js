$(document).ready(function(){
  ...
  $("#panel4Content").on('shown.bs.collapse',function(){
    $(".panel4Icon").removeClass("fa-arrow-down").addClass("fa-arrow-up");
  });
  $("#panel4Content").on('hidden.bs.collapse',function(){
    $(".panel4Icon").removeClass("fa-arrow-up").addClass("fa-arrow-down");
  });
  $("#panel5Content").on('shown.bs.collapse',function(){
    $(".panel5Icon").removeClass("fa-arrow-down").addClass("fa-arrow-up");
  });
  $("#panel5Content").on('hidden.bs.collapse',function(){
    $(".panel5Icon").removeClass("fa-arrow-up").addClass("fa-arrow-down");
  });
  $("#panel6Content").on('shown.bs.collapse',function(){
    $(".panel6Icon").removeClass("fa-arrow-down").addClass("fa-arrow-up");
  });
  $("#panel6Content").on('hidden.bs.collapse',function(){
    $(".panel6Icon").removeClass("fa-arrow-up").addClass("fa-arrow-down");
  });
  ...
  $(".check").on('click',function(e){
    ...
    $("#panel4Content").collapse('show');
    $("#panel5Content").collapse('show');
    $("#panel6Content").collapse('show');
  });
  ...
  $(".doCheck").on('click',function(e){
    ...
    $("#panel4Content").collapse('hide');
    $("#panel5Content").collapse('hide');
    $("#panel6Content").collapse('hide');
  });
});